...
const biography = 'Acredito em uma harmonização que respeita histórias, valoriza detalhes e revela o que há de mais autêntico em cada pessoa. Meu trabalho começa na escuta e termina em resultados que fazem sentido para você.';
...
function BrandSeal({ id }: { id: string }) {
  ...
  return <svg className={styles.seal} viewBox="0 0 120 120" aria-hidden="true" focusable="false">
    ...
    <text className={styles.sealText} textLength="280" lengthAdjust="spacing">
      <textPath href={`#${pathId}`} startOffset="1%">HARMONIZAÇÃO FACIAL · FERNANDA POSSAGNOLO · </textPath>
    </text>
    <text className={styles.sealMark} x="60" y="70" textAnchor="middle">fp.</text>
  ...
  return <section id="sobre" ref={root} className={styles.root} aria-labelledby="author-title">
    ...
    <div className={styles.stage}>
      ...
      <figure className={styles.photo} data-author-motion="photo">
        <Image
          ...
          alt="Retrato da Dra. Fernanda Possagnolo em fundo vinho."
          fill
      ...
      <article className={styles.card} data-author-motion="card">
        <p className={styles.cardLabel}>DRA. FERNANDA POSSAGNOLO</p>
    ...
    <footer className={styles.closing}>
      ...
      <div className={styles.closingRow}>
        <div className={styles.closingMonogram} aria-hidden="true"><strong>fp.</strong><span /></div>
