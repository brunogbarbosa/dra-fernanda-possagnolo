...
function SmileSeal() {
  ...
  return <div className="campaign-seal" role="img" aria-label="Beleza autêntica sem excessos">
    <svg viewBox="0 0 180 180" fill="none" aria-hidden="true">
      ...
      <text fill="currentColor" textAnchor="middle">
        <textPath href={`#${id}-top`} startOffset="50%">BELEZA AUTÊNTICA</textPath>
      </text>
      <text fill="currentColor" textAnchor="middle">
        <textPath href={`#${id}-bottom`} startOffset="50%">SEM EXCESSOS</textPath>
      </text>
  ...
  return <section ref={motionRef} id="inicio" className="campaign" aria-labelledby="campaign-title">
    ...
    <div className="campaign-inner">
      <div className="campaign-copy">
        <p className="campaign-kicker">HARMONIZAÇÃO QUE</p>
        ...
        <p className="campaign-subtitle">Naturalidade, técnica e intenção<br/>em perfeita harmonia.</p>
      ...
      <figure className="campaign-portrait">
        <div className="campaign-silhouette"><Image className="campaign-original" src="/images/fernanda-hero.webp" alt="Dra. Fernanda Possagnolo" fill preload sizes="(max-width:700px) 145vw, (max-width:1100px) 77vw, 60vw"/></div>
      </figure>
      <SmileSeal/>
      ...
      <div className="campaign-signature"><span aria-hidden="true"/><div><p>DRA. FERNANDA POSSAGNOLO</p><em>Harmonização Facial<br className="campaign-signature-break"/> com naturalidade.</em></div></div>
    </div>
  </section>;
}
