...
export const metadata: Metadata = {
  ...
  openGraph: { title: site.seo.title, description: site.seo.description, locale: 'pt_BR', type: 'website', images: ['/opengraph-image.png'] },
  twitter: { card: 'summary_large_image', title: site.seo.title, description: site.seo.description, images: ['/twitter-image.png'] },
};
